...
#include "Frugal-IoT.h"  // For Sensor_Float base class definition
#include "sensor_ds18b20_validated.h"
#include <cmath>
 ...
 */
Sensor_DS18B20_Validated::Sensor_DS18B20_Validated(const char* id, const char* name, uint8_t pin, uint8_t index, bool retain)
 ...
 */
float Sensor_DS18B20_Validated::readFloat() {
